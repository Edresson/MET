...
if motping[0] == 1 and celping[0] == 0 :
     ...
     print(" Aparentemente o Problema está com a port UDP: ",celping[2],file=log_file)
     sys.exit()
elif motping[0] == 0 and celping[0] == 1 :  
     print(" Aparentemente o Problema está com a port UDP:",motping[2],file=log_file)
     sys.exit()
    
elif motping[0] == 0 and celping[0] == 0:
    print(" Aparentemente o Problema está  no Raspberry Pi, Verifique se o ip dele é mesmo:",motping[1]," Caso não seja altere no arquivo IP-Raspberry.txt ",file=log_file)
    sys.exit()
...
class Ui_MainWindow():
    ...
    def setupUi(self, MainWindow):
        ...
        self.input2.setGeometry(QtCore.QRect(500, 50, 151, 21))
        ...
        self.botaobrowser.setGeometry(QtCore.QRect(800, 20, 100, 21))
...
"""def CriarPDF():
    ...
    if os.path.isdir("Ensaios/"+str(now.year)): # vemos se este diretorio já existe
         pass
    else:
      os.mkdir("Ensaios/"+str(now.year)) # aqui criamos o diretorio
    ...
    if os.path.isdir("Ensaios/"+str(now.year)+"/"+str(now.month)): # vemos se este diretorio já existe
         pass
    else:
      os.mkdir("Ensaios/"+str(now.year)+"/"+str(now.month)) # aqui criamos o diretorio
    ...
    if os.path.isdir("Ensaios/"+str(now.year)+"/"+str(now.month)+"/"+str(now.day)): # vemos se este diretorio já existe
         pass
    else:
      os.mkdir("Ensaios/"+str(now.year)+"/"+str(now.month)+"/"+str(now.day)) # aqui criamos o diretorio
